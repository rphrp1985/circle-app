...
class notificationview(name:String, id :String,uid:String,Isauthorised:Boolean): Fragment() {
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(
            ...
            R.layout.notificationview, container, false
        )



        if(!Isauthorised && name!="Home"){
            view.warningtext2.text  = "Your request to join $name is pending"
        }
